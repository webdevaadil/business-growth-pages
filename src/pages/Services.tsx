...
const testimonials = [
  {
    name: "Rahul Sharma",
    role: "Founder, RetailKart",
    text: "Tech3 built our ecommerce store professionally and delivered on time.",
  },
  {
    name: "Priya Verma",
    role: "CEO, EduSpark",
    text: "Great team with strong technical skills. Our MERN app runs flawlessly.",
  },
  {
    name: "Amit Patel",
    role: "Director, MediCare",
    text: "Smooth communication and quality code.",
  },
];
...
const Services = () => {
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      <Helmet>
        <title>
          Custom Web Development Services | Tech3 Technology
        </title>
        ...
        <link
          rel="canonical"
          href="https://tech3technology.in/services"
        />
        ...
        <meta
          property="og:url"
          content="https://tech3technology.in/services"
        />
        ...
        <section className="py-24 gradient-hero relative overflow-hidden">
          ...
          <div className="container relative z-10 px-6 text-center max-w-3xl">
            ...
            <p className="text-lg text-primary-foreground/70 mb-10">
              We create fast, scalable, and modern web solutions for
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <Button
                  variant="heroOutline"
                  size="xl"
                  className="text-primary-foreground border-primary-foreground/20 hover:bg-primary-foreground hover:text-primary w-full"
                >
                  WhatsApp Us
                </Button>
              </a>
        ...
        <section className="py-12 border-t border-border/50 bg-background">
          <div className="container px-6 max-w-4xl text-center">
            <p className="text-sm text-muted-foreground leading-relaxed">
              Tech3 Technology provides professional web
              development services including ecommerce development,
              MERN stack applications, React.js development,
              Node.js backend solutions, and custom software
